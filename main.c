    ...
    while (op != -1)
    {
        ...
        case (3):
            ...
            if (crioubase == 1)
            {
                ...
                printf("Indice primario inexistente para ser impresso, será criado após a definição da base de dados utilizando a opção 1 do menu!!!\n");
            break;
        case (4):
            nParticoes = 10;
            nElementos = 2;
        ...
        case (5):
            if (crioulistadenomes)
            {
                ...
                printf("Lista de nomes de arquivos inexistente para gerar partições, crie a estrutura de interpolação utilizando a opção 4 do menu!!!\n");
            break;
        case (6):
            if (crioulistadenomes)
            {
        ...
        case (10):
            ...
            if (crioubase == 1)
            {
                ...
                printf("Arquivo de índice primario inexistente para a criação da arvore binaria, crie utilizando a opção 1 do menu!!!\n");
            break;
        case (11):
